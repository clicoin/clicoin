...
// Copyright (c) 2009-2012 The Clicoin Core developers
...
CMD_REGEX= "perl -pi -e 's/(20\d\d)(?:-20\d\d)? The Clicoin/$1-%s The Clicoin/' %s"
REGEX_CURRENT= re.compile("%s The Clicoin" % year)
