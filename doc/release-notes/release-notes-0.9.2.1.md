Clicoin Core version 0.9.2.1 is now available from:

  https://clicoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 CIC to 0.01 CIC
...
- Fix "Start clicoin on system login"
