Clicoin Core version 0.9.4 is now available from:

  https://clicoin.org/bin/0.9.4/
...
this update is incompatible with the Clicoin system and could lead to consensus
forks.

Clicoin Core released binaries from https://clicoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~clicoin/+archive/ubuntu/clicoin
- A third-party or self-compiled Clicoin Core

upgrade to Clicoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
