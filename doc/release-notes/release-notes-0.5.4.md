Clicoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/clicoin/files/Clicoin/clicoin-0.5.4/
...
http://gitorious.org/clicoin/clicoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Clicoin-Qt notifications under Growl 1.3.
Increase required age of Clicoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxClicoin properly when installing Clicoin-Qt over it. (Windows)
