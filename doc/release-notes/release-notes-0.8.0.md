Clicoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/clicoin/files/Clicoin/clicoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Clicoin
...
New/changed settings (command-line or clicoin.conf file)
--------------------------------------------------------
