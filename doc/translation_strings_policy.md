...
This document provides guidelines for internationalization of the Clicoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `clicoin_en.ts` remains unchanged.
