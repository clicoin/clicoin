...
#ifndef CLICOIN_TEST_SCRIPTNUM10_H
#define CLICOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Clicoin Core 0.10.0, for cross-comparison.
 */
public:
