// Copyright (c) 2013-2015 The Clicoin Core developers
...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    UniValue r;
    CPubKey demoPubkey;
    CClicoinAddress demoAddress;
    UniValue retValue;
    string strAccount = "walletDemoAccount";
    CClicoinAddress setaccountDemoAddress;
    {
        LOCK(pwalletMain->cs_wallet);

        demoPubkey = pwalletMain->GenerateNewKey();
        demoAddress = CClicoinAddress(CTxDestination(demoPubkey.GetID()));
        ...
        setaccountDemoAddress = CClicoinAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    }
    /*********************************
     * 			setaccount
     *********************************/
    ...
    BOOST_CHECK(CClicoinAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CClicoinAddress(arr[0].get_str()).Get() == demoAddress.Get());
