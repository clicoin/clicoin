...
{
    BOOST_CHECK(TestSplitHost("www.clicoin.org", "www.clicoin.org", -1));
    BOOST_CHECK(TestSplitHost("[www.clicoin.org]", "www.clicoin.org", -1));
    BOOST_CHECK(TestSplitHost("www.clicoin.org:80", "www.clicoin.org", 80));
    BOOST_CHECK(TestSplitHost("[www.clicoin.org]:80", "www.clicoin.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:5227", "127.0.0.1", 5227));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:5227", "127.0.0.1", 5227));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:5227", "::ffff:127.0.0.1", 5227));
    BOOST_CHECK(TestSplitHost("[::]:5227", "::", 5227));
    BOOST_CHECK(TestSplitHost("::5227", "::5227", -1));
    BOOST_CHECK(TestSplitHost(":5227", "", 5227));
    BOOST_CHECK(TestSplitHost("[]:5227", "", 5227));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:5227", "127.0.0.1:5227"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:5227", "[::]:5227"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
