...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", DEFAULT_CHOOSE_DATADIR))
    {
        ...
        intro.setWindowIcon(QIcon(":icons/clicoin"));
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Clicoin Core"),
     ...
     * override -datadir in the clicoin.conf file in the default data directory
     * (to be consistent with clicoind behavior)
     */
    if(dataDir != getDefaultDataDirectory())
