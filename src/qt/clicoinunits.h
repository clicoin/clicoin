...
#ifndef CLICOIN_QT_CLICOINUNITS_H
#define CLICOIN_QT_CLICOINUNITS_H
...
/** Clicoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class ClicoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit ClicoinUnits(QObject *parent);

    /** Clicoin units.
      @note Source: https://en.clicoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        CIC,
...
typedef ClicoinUnits::Unit ClicoinUnit;

#endif // CLICOIN_QT_CLICOINUNITS_H
