...
unlocked to sign the Clicoin-Qt.app bundle.
...
allowing somebody to distribute a Clicoin-Qt.app or clicoin-qt-setup.exe with a valid
...
that the clicoin-qt.exe file inside the installer had not been tampered with.
